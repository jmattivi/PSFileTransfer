function Remove-SFTPFile
{
    ...
    .PARAMETER FileName
        File name to create on remote host
    ...
    .EXAMPLE
        ...
        Remove-SFTPFile -Server ServerX -Path "/root/dir/" -FileName $FileName-Credential $Cred
        
    .EXAMPLE
        Remove-SFTPFile -Server ServerX -Path "/root/dir/" -FileName $FileName -UserName svcaccount -KeyFilePath C:\sshkeys\ServerX.key
